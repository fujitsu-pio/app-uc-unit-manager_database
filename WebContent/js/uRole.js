...
function createChunkedRoleTable(json, recordSize){
	...
	for(var count = recordSize; count < maxLimit; count++) {
		...
		//Rows Start
			...
			//dynamicTable += '<td name = "acc" style="width:33%;max-width: 200px"><div class = "mainTableEllipsis"><a href = "#" id="roleNameLink" class="roleNameLink" onclick="openRoleAccountLinkMappingPage('+roleName+','+boxName+','+test+','+test2+','+infoCreatedat+', '+infoUpdatedat+','+infoSchema+');" title= "'+name[count]+'">'+name[count]+'</a></div></td>';//openRoleAccountLinkMappingPage('+roleName+','+boxName+','+roleDate+','+accountCount+');
			dynamicTable += '<td name = "acc" style="width:33%;max-width: 200px"><div class = "mainTableEllipsis"><a href = "#" id="roleNameLink" class="roleNameLink" onclick="openRoleAccountLinkMappingPage('+roleName+','+boxName+','+test+','+test2+','+infoCreatedat+', '+infoUpdatedat+','+infoSchema+');" title= "'+name[count]+'" tabindex ="-1" style="outline:none">'+name[count]+'</a></div></td>';//openRoleAccountLinkMappingPage('+roleName+','+boxName+','+roleDate+','+accountCount+');
