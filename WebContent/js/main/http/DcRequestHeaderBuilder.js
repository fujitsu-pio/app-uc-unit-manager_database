...
//*/
/**
 * It creates a new object dcc.DcHttpClient.
 * @class This is a builder class that generates a request header object.
 * @constructor
 */
dcc.DcRequestHeaderBuilder = function() {
 ...
 */
dcc.DcRequestHeaderBuilder.prototype.initializeProperties = function() {
///** ContentType値. */
  /** ContentType value. */
 ...
 */
dcc.DcRequestHeaderBuilder.prototype.accept = function(value) {
 ...
 * @return {Object} Its own object
 */
dcc.DcRequestHeaderBuilder.prototype.contentType = function(value) {
 ...
 * @return {Object} Its own object
 */
dcc.DcRequestHeaderBuilder.prototype.etag = function(value) {
 ...
 * @return {Object} Its own object
 */
dcc.DcRequestHeaderBuilder.prototype.token = function(value) {
 ...
 * @return {Object} Its own object
 */
dcc.DcRequestHeaderBuilder.prototype.acceptEncoding = function(value) {
 ...
 * @return {Object} Its own object
 */
dcc.DcRequestHeaderBuilder.prototype.ifMatch = function(value) {
 ...
 * @return {Object} Its own object
 */
dcc.DcRequestHeaderBuilder.prototype.ifNoneMatch = function(value) {
 ...
 * @return {Object} Its own object
 */
dcc.DcRequestHeaderBuilder.prototype.depth = function(value) {
 ...
 * @return {Object} Its own object
 */
dcc.DcRequestHeaderBuilder.prototype.defaultHeaders = function(value) {
 ...
 * @return {Object} Its own object
 */
dcc.DcRequestHeaderBuilder.prototype.xdcRecursive = function(value) {
 ...
 */
dcc.DcRequestHeaderBuilder.prototype.getContentType = function() {
 ...
 */
dcc.DcRequestHeaderBuilder.prototype.getAccept = function() {
 ...
 */
dcc.DcRequestHeaderBuilder.prototype.getETag = function() {
 ...
 */
dcc.DcRequestHeaderBuilder.prototype.getToken = function() {
 ...
 */
dcc.DcRequestHeaderBuilder.prototype.getAcceptEncoding = function() {
 ...
 */
dcc.DcRequestHeaderBuilder.prototype.getDepth = function() {
 ...
 */
dcc.DcRequestHeaderBuilder.prototype.getIfMatch = function() {
 ...
 */
dcc.DcRequestHeaderBuilder.prototype.getIfNoneMatch = function() {
 ...
 */
dcc.DcRequestHeaderBuilder.prototype.getXdcRecursive = function() {
 ...
 * @param {dcc.DcHttpClient} Request object
 * @param {Object} header parameters
 * @return {dcc.DcHttpClient} Request object
 */
dcc.DcRequestHeaderBuilder.prototype.build = function(req, headers) {
