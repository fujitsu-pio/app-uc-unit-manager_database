 ...
 * @param {Boolean} async
 */
dcc.DcHttpClient = function(async) {
  this.requestHeaders = [];
 ...
 */
dcc.DcHttpClient.prototype.setRequestHeader = function(key, value) {
  var header = {};
  header[key] = value;
 ...
 */
dcc.DcHttpClient.prototype.setOverrideMimeType = function(value) {
 ...
 */
dcc.DcHttpClient.prototype.getStatusCode = function() {
 ...
 */
dcc.DcHttpClient.prototype.getResponseHeader = function(key) {
 ...
 */
dcc.DcHttpClient.prototype.getAllResponseHeaders = function() {
 ...
 */
dcc.DcHttpClient.prototype.bodyAsString = function() {
 ...
 */
dcc.DcHttpClient.prototype.bodyAsBinary = function() {
 ...
 */
dcc.DcHttpClient.prototype.bodyAsJson = function() {
  try {
 ...
 */
dcc.DcHttpClient.prototype.bodyAsXml = function() {
 ...
 */
dcc.DcHttpClient.prototype._execute = function(method, requestUrl, requestBody, callback) {
  var self = this;
 ...
 * @returns {dcc.Promise} Promise object
 */
dcc.DcHttpClient.prototype._execute2 = function(method, requestUrl, options, accessor) {
  var self = this;
  var xhr = this.httpClient;
  var promise = new dcc.Promise();
  var requestBody = "";
 ...
 */
dcc.DcHttpClient.prototype.setAsync = function(async){
  this.async = async;
};