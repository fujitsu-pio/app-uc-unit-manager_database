...
/**
 * It creates a new object dcc.DcResponse.
 * @class This class is used to handle DAV Response.
 * @param {Object} response object
 * @constructor
 * @param {Object} resObj
 */
dcc.DcResponse = function(resObj) {
 ...
 * @param {Object} response object
 */
dcc.DcResponse.prototype.initializeProperties = function(resObj) {
 ...
 */
dcc.DcResponse.prototype.getStatusCode = function() {
 ...
 */
dcc.DcResponse.prototype.getHeader = function(key) {
 ...
 */
dcc.DcResponse.prototype.bodyAsString = function() {
 ...
 * @throws {dcc.DaoException} Client Exception
 */
dcc.DcResponse.prototype.bodyAsJson = function() {
  try {
    //this.response.bodyAsString
    return JSON.parse(this.response.responseText);

  } catch (e) {
    throw new dcc.DaoException("parse exception: " + e.message, 0);
  }
};
 ...
 */
dcc.DcResponse.prototype.bodyAsXml = function() {
 ...
 * @param {dcc.DcHttpClient} httpResponse
 */
dcc.DcResponse.prototype.debugHttpResponse = function(res) {
  if (res !== null) {
