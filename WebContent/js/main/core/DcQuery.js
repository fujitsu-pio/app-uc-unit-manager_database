...
//*/
/**
 * It creates a new object dcc.DcQuery.
 * @class This class specifies the search criteria for OData, to perform the search.
 * @constructor
 * @param {Object} obj
 */
dcc.DcQuery = function(obj) {
  this.initializeProperties(obj);
};

///**
//* プロパティを初期化する.
//* @param {dcc.DcQuery} obj
//*/
/**
 * This method initializes the properties of this class.
 * @param {dcc.DcQuery} obj
 */
dcc.DcQuery.prototype.initializeProperties = function(obj) {
  this.target = obj;
};
 ...
 */
dcc.DcQuery.prototype.run = function(callback) {
...
///**
//* 検索を実行します.
//* @return {dcc.ODataResponse} 検索結果のJSONオブジェクト
//* @throws {DaoException} DAO例外
//*/
/**
 * This method executes the search and returns result as response.
 * @return {dcc.ODataResponse} JSON object of the search results
 * @throws {dcc.DaoException} DAO exception
 */
dcc.DcQuery.prototype.runAsResponse = function(callback) {
  if (callback !== undefined) {
    this.target.doSearchAsResponse(this, function(resp) {
      if (resp.getStatusCode() >= 300) {
        ...
        if (callback.success !== undefined) {
          ...
          callback.success(new dcc.ODataResponse(this.accessor, "", json));
        }
      }
      if (callback.complete !== undefined) {
        callback.complete(resp);
 ...
 */
dcc.DcQuery.prototype.makeQueryString = function() {
 ...
 */
dcc.DcQuery.prototype.makeQueryList = function() {
  var al = [];
  if (this.topVal > 0)  {
...
//* @return {dcc.DcQuery} Queryオブジェクト自身
//*/
/**
 ...
 */
dcc.DcQuery.prototype.filter = function(value) {
 ...
 * @return {dcc.DcQuery} Query object
 */
dcc.DcQuery.prototype.top = function(value) {
  this.topVal = value;
  return this;
};
 ...
 * @return {dcc.DcQuery} Query object
 */
dcc.DcQuery.prototype.skip = function(value) {
  this.skipVal = value;
  return this;
};
 ...
 * @return {dcc.DcQuery} Query object
 */
dcc.DcQuery.prototype.select = function(value) {
 ...
 * @return {dcc.DcQuery} Query object
 */
dcc.DcQuery.prototype.expand = function(value) {
 ...
 * @return {dcc.DcQuery} Query object
 */
dcc.DcQuery.prototype.orderby = function(value) {
 ...
 * @return {dcc.DcQuery} Query object
 */
dcc.DcQuery.prototype.inlinecount = function(value) {
 ...
 * @return {dcc.DcQuery} Query object
 */
dcc.DcQuery.prototype.q = function(value) {
  this.qVal = value;
  return this;
};
 ...
 * @return {dcc.DcQuery} Query object
 */
dcc.DcQuery.prototype.parentType = function(value) {
 ...
 * @return {dcc.DcQuery} Query object
 */
dcc.DcQuery.prototype.parentId = function(value) {
