...
///** カスタマイズ可能な情報を管理するオブジェクト. */
  /** {dcc.DaoConfig} Object that manages a customizable information. */
  self.config = new dcc.DaoConfig();
...
dcc.DcContext.prototype.getDaoConfig = function() {
  return this.config;
};
 ...
 */
dcc.DcContext.prototype.asAccount = function(cellUrl, userId, password) {
 ...
 * @throws {dcc.DaoException} DAO exception
 */
dcc.DcContext.prototype.getAccessorWithAccount = function(cellUrl, userId, password) {
