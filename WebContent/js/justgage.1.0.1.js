...
JustGage = function(config) { 
  ...
  this.config = 
  {
    ...
    svalue : (config.svalue) ? config.svalue : 0,

    maxvalue : (config.maxvalue) ? config.maxvalue : 0,
    
    sizeunit : (config.sizeunit) ? config.sizeunit : "Byte",
  ...
  // overflow values
  if (config.svalue > this.config.max) this.config.svalue = this.config.max; 
  if (config.svalue < this.config.min) this.config.svalue = this.config.min;
  this.originalValue = config.svalue+"%";
  ...
  // min
  this.txtMin = this.canvas.text(this.params.minX, this.params.minY, this.config.min + config.sizeunit);
  this.txtMin. attr({
  ...
  // max
  this.txtMax = this.canvas.text(this.params.maxX, this.params.maxY, this.config.maxvalue + config.sizeunit);
  this.txtMax. attr({
