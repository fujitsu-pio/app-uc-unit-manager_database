					...
					<ul class="navList">
						...
						<li id="roleNav" class="roleNav" onclick="roleListData();">
							<div id="roleTabWrapper" class="roleTabWrapper">
								...
								<label id="roleText" class="roleText">Role</label>
							</div>
						</li>
						...
						<li id="messageNav" class="messageNav">
							<div id="messageTabWrapper" class="messageTabWrapper" >
								...
								<label id="messageText" class="messageText">Message</label>
						...
						<li id="logNav" class="logNav" onclick="uMainNavigation.logViewData();">
							<div id="logTabWrapper" class="logTabWrapper">
								...
								<label id="logText" class="logText">Log</label>
							</div>
						</li>
						<li id="infoNav" class="infoNav" onclick="uMainNavigation.CellInfoNavigationData();">
							<div id="infoTabWrapper" class="infoTabWrapper">
								<div id="infoIcon" class="infoIcon"></div>
								<label id="infoText" class="infoText">Info</label>
							</div>
						</li>
					</ul>
				</div>
...
<!-- Start: Cell Create Template and Create Popup UI -->
		...
		<div class="modal-window block-border"
			...
			<div id="selectTemplateBody">
				<div class="popupCellHeader">
					<div class="popupCellHeading">Create Cell</div>
				...
				<div class="popupCellBody">
					<div class="popupCellBodyRow" id="selTemplateRow0"
						...
						<div class="popupCellBodyLeft">Cell</div>
						<div class="popupCellBodyRight">Create a blank cell to get started.</div>
					</div>
				</div>
				<div style="margin-right: 10px;"></div>
				<div class="popupCellBottom">
					<div class="pageFwdIcon" onClick="cellpopup.createCellUI();" tabindex="1" id="btnFwdCellCreate" title="Next"></div>
				</div>
			</div>
			...
			<div id="createCellBody" style="display: none;">
				...
				<div class="popupCreateCellBody">
					<div id="leftSection" class="cellPopupLeft">
						<div class="popuplabeltop " style="margin-top: 48px;">*CellName</div>
						<input type="text" class="popupTextBox"
							id="textCellPopup" onkeyup="cellpopup.populateCellURL();" tabindex="1"/> <span
							class="popupAlertArea">
							<aside class="cellpopupInlineComment LHSAlertMessage" id="popupCellNameErrorMsg"></aside>
						</span>
						<div class="popuplabel" id="cellURLTitle">Cell URL</div>
						...
						<div class="popuplabel">
							...
							<div style="margin-left: 23px; line-height: 16px;">Create
								Account with Admin Role</div>
						</div>

						<div class="popuplabeldisabled" id="trAdmin">
							Admin Name <input type="text" 
								...
								<aside class="cellpopupInlineComment LHSAlertMessage" id="popupRoleNameErrorMsg"></aside>
							</span>
						</div>
					</div>
					...
					<div class="RHSElements" id="cellProfileElements">
						<div class="popuplabeltop">Display Name</div>
						<input type="text" class="popupTextBox"
							id="trDisplayName" disabled tabindex="5"/>
							<span  style="height: 6px;" class="popupAlertArea">
							<aside class="popupAlertmsg RHSAlertMsg" id="popupCellDisplayNameErrorMsg"></aside>
						</span>
						<div class="popuplabel">
							Description
							<!-- <textarea rows="5" cols="33" class="cellpopuplabel"
							...
							<aside class="popupAlertmsg RHSAlertMsg" id="popupCellDescriptionErrorMsg"></aside>
						</span>
						</div>
						<div id="dvApplicationCellProfileImage"
						class="popuplabeltop" style="margin-top: 13px;margin-bottom: 10px;">Application Image</div>
					<section class="positionImageSection" id="imgCellProfileSection">
							...
							<div id="dvCellBrowseButtonSection" class="browseButtonSection" >
								<div>
									<label class="itemInfo positionImageInfo"
										id="lblCellNoFileSelected">No file selected </label>
								</div>
								<div class="browseButton">
									<div id="dvCellBrowse" class="file-input-wrapper">
										<button title="" id="btnCellProfileBrowse" style="cursor: default" class="btn-file-input btnDisabled">Browse</button>
						...
						<div>
							<label class="floatLeft itemInfo" id="cellImageInfo"> You can
								upload any image of size max. 50 kb, dimension<br> 180px x
								180 px in JPEG/PNG format
							</label>
						</div>
						<span  style="height: 6px;" class="popupAlertArea">
							<aside class="popupAlertmsg RHSAlertMsg" id="popupCellImageErrorMsg"></aside>
						</span>
					</section>
						<div class="popuplabel" id="btnPublic">
							<div style="float: left;">
							...
							<div style="margin-left: 23px; line-height: 16px;">Allow anyone to read the profile</div>
						</div>
						<!-- <div class="popuplabel">
							Application Image
				...
				<div class="popupCellCreateBottom">
					<div class="pagePrevIcon" onClick="cellpopup.moveToPrevPage();" tabindex="9" title="Previous"></div>
					<div class="createCellIcon"
						onClick="cellpopup.performCellCreate();" tabindex="11" title="Create"></div>
					<div class="cancelCellCreateIcon" onClick="cellpopup.closePopup();" tabindex="10" title="Cancel"></div>
				</div>
			</div>
			<!-- Create Cell Popup: end -->
		</div>
	...
	<div id="tokenPopUpModalWindow" class="modelback"
		style="display: none;">
		<div class="modal-window block-border"
			style="display: block; height: 499px; width: 706px; background: #ffffff"
			id="tokenDialogBox">
			...
			<div class="accessTokenLabel">
				<label>To use API with the same privilege as the portal for
					administering the environment, please copy the token below (ctrl+c)
					and paste (ctrl+v) to the authorization header as access token. </label>
			</div>
			...
			<div id="dvClose" class="dvClose">
				<input type="button" id="btnClose" class="btnClose"
					onclick="closeEntityModal('#tokenPopUpModalWindow')" value="Close" tabindex="2">
			</div>
		</div>
	</div>
	<!-- -Token POP up End -->
	...
	<div id="timeOutCellProfileModalWindow" class="modelback"
		...
		<div class="modal-window block-border"
			...
			<section class="headerSection">
				<div id="dvCloseIcon" class="closeIconDiv">
					<a style="margin: 0px;" href="#" title="Close" id="modalbox-close"
				...
				<div class="sessionExpiryDiv" id="dvAccessheader">
					<label class="sessionExpiredPopUpHeading"
						id="lblHeadingAccessToken"> Session Expired</label>
				</div>
			</section>
			...
			<div id="dvClose" class="sessionPopUpCloseSection">
				<input type="button" id="btnTimeout" class="normalButton"
					onclick="window.close();" value="Ok" tabindex="1">
			</div>
		</div>
	</div>
