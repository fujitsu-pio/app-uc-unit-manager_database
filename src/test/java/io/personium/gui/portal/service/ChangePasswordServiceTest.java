...
import io.personium.gui.portal.dao.ChangePasswordDAO;
...
public class ChangePasswordServiceTest {
	...
	public void testValidateAndUpdatePasswordWhenSuccess() throws Exception{
		...
		//mockSHAHashing.salt = "";
		EasyMock.expect(
				mockChangePasswordDAO.changePassword(userName, encryptedPassphrase, testSalt, passwordResetAt, updatedAt, PersoniumConstants.DEFUALT_LOCK_STATUS))
				.andReturn(1);
