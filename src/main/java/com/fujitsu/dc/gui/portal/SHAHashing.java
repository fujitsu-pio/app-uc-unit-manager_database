...
public class SHAHashing {
      ...
      * @throws PCSCustomException exception
      */
     public String validateHashedPassword(String salt, String password) throws PCSCustomException {
          String saltedPassword = salt + password;
          String hashedPassword = generateHash(saltedPassword);
          return hashedPassword;
      ...
      * @throws PCSCustomException exception
      */
     private String generateHash(String input) throws PCSCustomException {
          ...
          try {
               ...
               throw new PCSCustomException("NoSuchAlgorithmException" + exe);
          }
