...
public class DbUtil {
     ...
     */
      ...
      * @throws PCSCustomException exception
      */
     public static Connection getConnection() throws PCSCustomException {
          if (connection != null) {
               return connection;
          } else {
               try {
                    ...
                    exe.printStackTrace();
                    throw new PCSCustomException("FileNotFoundException" + exe);
               } catch (IOException exe) {
                    exe.printStackTrace();
                    throw new PCSCustomException("PCSCustomException" + exe);
               } catch (RuntimeException exe) {
                    exe.printStackTrace();
                    throw new PCSCustomException("RuntimeException" + exe);
               }
               return connection;
          }
     }
