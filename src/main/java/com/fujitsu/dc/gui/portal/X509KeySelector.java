...
public class X509KeySelector extends KeySelector {
     ...
     private final Map<String, X509Certificate> caCerts = new HashMap<String, X509Certificate>();

     /**
      * Default root CA certificate path.
      */
     public static final String DEFAULT_ROOT_CA_PATH = "x509/cacert.crt";

     /**
      * Default server certificate key path.
      */
     public static final String DEFAULT_SERVER_KEY_PATH = "x509/certificate.key";

     /**
      * Default server certificate path.
      */
     public static final String DEFAULT_SERVER_CRT_PATH = "x509/certificate.crt";
      ...
      */
     private void cheakX509validate(X509Certificate certificate)
     ...
     private void readCaFile(InputStream is) throws IOException,
          ...
          X509Certificate x509Root = (X509Certificate) cf
                    .generateCertificate(new ByteArrayInputStream(bytesCert));
          // ルートCA証明書の期限切れチェック
      ...
      *             CertificateException
      */
     public void readRoot(List<String> rootCaFileName) throws IOException,
               CertificateException {

          // 設定が無い場合はデフォルトルートCA証明書を使う
          if (rootCaFileName == null || rootCaFileName.size() == 0) {
               readCaFile(TransCellAccessToken.class.getClassLoader()
                         .getResourceAsStream(DEFAULT_ROOT_CA_PATH));
               return;
          }
     ...
     @Override
     public final KeySelectorResult select(final KeyInfo keyInfoToUse,
