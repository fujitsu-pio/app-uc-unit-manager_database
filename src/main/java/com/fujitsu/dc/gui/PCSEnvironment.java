 ...
 */
  public class PCSEnvironment {
     private static PCSEnvironment environment = null;;
      ...
      */
     public static synchronized PCSEnvironment getInstance() {
          if (environment == null) {
               environment = new PCSEnvironment();
