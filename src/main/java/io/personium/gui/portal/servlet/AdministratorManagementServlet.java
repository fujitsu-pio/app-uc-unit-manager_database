...
public class AdministratorManagementServlet extends HttpServlet {
     ...
     protected boolean createNewUser(HttpServletRequest request,
          ...
          String firstName = URLDecoder.decode(request.getParameter("firstName"), PersoniumConstants.UTF8);
          String familyName = URLDecoder.decode(request.getParameter("familyName"), PersoniumConstants.UTF8);
          String email = URLDecoder.decode(request.getParameter("encodedEAddress"), PersoniumConstants.UTF8);
          ...
          try {
               ...
               String status = PersoniumConstants.INACTIVE_USER_STATUS;
     ...
     * @throws Exception exception
     ...
     protected JSONArray retrieveActiveUserList(HttpSession session) throws Exception {
          ...
          int lockStatus = 0;
          String status = PersoniumConstants.DEFAULT_USER_STATUS;
          AdministratorManagementService administratorManagementService =
                  new AdministratorManagementService();
     ...
     protected String updateUserDetails(HttpServletRequest request) throws UnsupportedEncodingException {
          ...
          String newEmail =  URLDecoder.decode(request.getParameter("encodedNewEAddress"), PersoniumConstants.UTF8);
