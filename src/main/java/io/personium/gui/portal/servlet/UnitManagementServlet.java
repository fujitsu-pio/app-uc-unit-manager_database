...
import io.personium.gui.portal.service.UnitManagementService;
...
public class UnitManagementServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        if (session != null) {
            ...
            unitManagementService = new UnitManagementService();
            String unitId = URLDecoder.decode(request.getParameter("unitId"), PersoniumConstants.UTF8);
            String unitName = URLDecoder.decode(request.getParameter("unitName"), PersoniumConstants.UTF8);
