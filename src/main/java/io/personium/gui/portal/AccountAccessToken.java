...
public final class AccountAccessToken extends CellLocalAccessToken implements IAccessToken {
    ...
    public AccountAccessToken(final long issuedAt, final long lifespan, final String issuer,
            final String subject, final String schema, final String userName) {
        super(issuedAt, lifespan, issuer, subject, null, schema, userName);
    }
     ...
     * @param userName userName
     */
    public AccountAccessToken(final long issuedAt, final String issuer,
     final String subject, final String schema, final String userName) {
        this(issuedAt, ACCESS_TOKEN_EXPIRES_HOUR * MILLISECS_IN_AN_HOUR, issuer, subject, schema, userName);
    }
